...
const BLOCKED_CASES = [
  {
    ...
    validatorReason: 'Surface-level fear metrics don\'t justify exit when fundamentals intact',
    varScore: 228,
    riskScore: 67,
    txHash: '0x22273b79a8f73998576f7e76c3699e70024bcbeb048d70e49d7fd19ca2693001',
    marketAfter: '+1.2%',
  ...
  },
  {
    ...
    validatorReason: 'Low mETH volume ≠ weak market. Swap locks agent out of recovery',
    varScore: 193,
    riskScore: 67,
    txHash: '0x4843e59763f262973b1c10129c63543ab475f0b0f0fb7fdf5bba4bf14ffb9ef1',
    marketAfter: '+1.2%',
    savedEstimate: '~$25 per $2,000',
  ...
  },
  {
    ...
    validatorReason: '1.4% funding is not historically extreme — unwinding risk overstated',
    varScore: 228,
    riskScore: 58,
    txHash: '0x01ac8df0ff7470bb0b16ebfb9b0bf361e8c6aa80671a63df35e07d9e0c69157a',
    marketAfter: '+1.2%',
    savedEstimate: '~$25 per $2,000',
