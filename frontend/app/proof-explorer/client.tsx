          ...
          <section className="glass-card p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3">
              {[
                ...
                { name: 'Elfa', role: 'Social intelligence — mindshare, mention velocity', detail: 'REST API v1 · /v1/top-mentions + /v1/trending-tokens', proof: 'https://github.com/USBVadik/TuringVault-Core/blob/main/src/data/elfa.js', proofLabel: 'src/data/elfa.js' },
