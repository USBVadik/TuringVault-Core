...
module.exports = {
  ...
  IDLE_PARKING_COOLDOWN_MS: num('RWA_IDLE_PARKING_COOLDOWN_MS', 6 * 60 * 60 * 1000),
  ...
  IDLE_PARKING_MIN_FLAT_MS: num('RWA_IDLE_PARKING_MIN_FLAT_MS', 24 * 60 * 60 * 1000),

  // Fraction of idle stable-USD balance to park per Path B trigger.
  // 0.20 = move 20% of idle USDT into USDT0 each parking event.
  IDLE_PARKING_FRACTION: num('RWA_IDLE_PARKING_FRACTION', 0.20),
};
