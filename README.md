...
| **Elfa** | Social intelligence — mindshare, smart-account mentions, entity-graph sentiment | [`src/data/elfa.js`](src/data/elfa.js) — wired into `signalEngine.js` as 5th signal + `/api/elfa-snapshot` (REST API v1 paths from open-source AgentiPy reference) | ✅ Live (free tier, 60 RPM) |
