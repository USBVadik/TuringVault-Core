...
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- |
| **On-chain benchmarking of AI**      | 4 attestation TXs per cycle (proposal, validation, decisionLog, reputation) — 287 decisions in the 2026-06-04 snapshot, 211 approved, 76 blocked before execution, full reasoning hash anchored on every one                                  | Mantlescan + GitHub Actions hourly cron log |
...
3. **Refusal-with-proof beats unverifiable execution** — 76/287 proposals blocked before execution in the 2026-06-04 snapshot; every block has reasoning hash on Mantle. For DAO treasuries / compliance-conscious operators, this is the entire reason to use an AI agent at all.
