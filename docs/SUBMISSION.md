...
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- |
| **On-chain benchmarking of AI**      | 4 attestation TXs per cycle (proposal, validation, decisionLog, reputation) — 288 DecisionLog rows in the 2026-06-04 16:15 UTC snapshot; ValidationRegistry shows 213 approved and 76 rejected out of 289 proposals, with full reasoning pinned off-chain and hash-anchored on Mantle | Mantlescan + GitHub Actions hourly cron log |
...
3. **Refusal-with-proof beats unverifiable execution** — 76/289 ValidationRegistry proposals rejected before execution in the 2026-06-04 16:15 UTC snapshot; every block has reasoning pinned off-chain and hash-anchored on Mantle. For DAO treasuries / compliance-conscious operators, this is the entire reason to use an AI agent at all.
