...
| # | Claim | Open this |
|---|-------|-----------|
| 1 | **288 DecisionLog rows on Mantle Mainnet** (2026-06-04 17:05 UTC snapshot; live count grows every cycle) | [DecisionLog events](https://explorer.mantle.xyz/address/0x7bCd905678ed5dB1e87852b933f1aEfE544cfbB5) |
...
**288 DecisionLog rows** logged in the 2026-06-04 17:05 UTC snapshot. **76 of 289 registry proposals rejected before execution** = **26.3% rejected before execution**. _Rejection-with-proof is a first-class output, not a failure mode._
...
## 📊 Live State (observed from live API on Mantle Mainnet, chain 5000, 2026-06-04 17:05 UTC)
...
Last cycle age             about 92 min in this observed snapshot
NAV                      $151.22  operator-funded demo capital, not claimed trading profit
...
|---|---|---|
| AI consensus pipeline | ✅ Live | 288 DecisionLog rows in the 2026-06-04 17:05 UTC snapshot; live count grows every cycle |
